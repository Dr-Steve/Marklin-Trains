...
public class SerialWriter {
    ...
    static String          messageString = "c";
    static char go = 0x60;
    static char stop = 0x61;
    static char control26 = 0x1a;
    static char slow = 0x02;
    ...
    while (portList.hasMoreElements()) {
        ...
        if (portId.getName().equals(defaultPort)) {
            ...
            try {
            serialPort = 
                (SerialPort) portId.open("SerialWriter", 2000);
            ...
            //outputStream.write(slow);
            //outputStream.write(control26);
            //outputStream.write(slow);
